...
implicit none
  ...
  if (my_rams_num .eq. mainnum) then
    ...
    CALL par_put_float (BRNC1_MAX,1)
    CALL par_put_float (BRNC2_MAX,1)
    ...
    CALL par_get_float (BRNC1_MAX,1)
    CALL par_get_float (BRNC2_MAX,1)
