...
!!!!!  All grids must have same scalars defined !!!!!!!
   ...
   if (allocated(micro_g(1)%brc1np))   allocate (tend%brc1nt(ntpts))
   if (allocated(micro_g(1)%brc2np))   allocate (tend%brc2nt(ntpts))
   if (allocated(micro_g(1)%brc1mp))   allocate (tend%brc1mt(ntpts))
   if (allocated(micro_g(1)%brc2mp))   allocate (tend%brc2mt(ntpts))
...
! Deallocate all tendency arrays
   ...
   if (allocated(tend%brc1nt)) deallocate (tend%brc1nt)
   if (allocated(tend%brc2nt)) deallocate (tend%brc2nt)
   if (allocated(tend%brc1mt)) deallocate (tend%brc1mt)
   if (allocated(tend%brc2mt)) deallocate (tend%brc2mt)
...
! Fill scalar arrays into scalar tables
   ...
   if (allocated(tend%brc1nt))  &
      CALL vtables_scalar (micro%brc1np(1,1,1),tend%brc1nt(1),ng,'BRC1NP')
   if (allocated(tend%brc2nt))  &
      CALL vtables_scalar (micro%brc2np(1,1,1),tend%brc2nt(1),ng,'BRC2NP')
   if (allocated(tend%brc1mt))  &
      CALL vtables_scalar (micro%brc1mp(1,1,1),tend%brc1mt(1),ng,'BRC1MP')
   if (allocated(tend%brc2mt))  &
      CALL vtables_scalar (micro%brc2mp(1,1,1),tend%brc2mt(1),ng,'BRC2MP')
