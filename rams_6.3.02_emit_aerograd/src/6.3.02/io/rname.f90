...
DATA INDAT/  &
     ...
     ,'ITRKDUSTIFN','SCMTIME','ISCMX','ISCMY','FRACSAT','IBRNC'          &
     ,'BRNC1_MAX','BRNC2_MAX'/
DATA SOUND/  &
...
IF(GROUP.EQ.'$MODEL_OPTIONS') THEN
 ...
 IF(VR.EQ.'IBRNC')        CALL varseti (VR,IBRNC,NV,1,II,0,1)
 ...
 IF(VR.EQ.'BRNC1_MAX')    CALL varsetf (VR,BRNC1_MAX,NV,1,FF,0.,1.E4)
 IF(VR.EQ.'BRNC2_MAX')    CALL varsetf (VR,BRNC2_MAX,NV,1,FF,0.,1.E4)
