...
elseif(cvar(1:lv).eq.'brown_carbon1_concen') then
   ivar_type=3
   ierr=rams_getvar('BRC1NP',idim_type,ngrd,a,flnm)
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   if(ierr.eq.0) then
    CALL rams_comp_dn0 (n1,n2,n3,b,c,d,e,ngrd)
    CALL rams_comp_mult (n1,n2,n3,a,d)
   ...
   cdname='brown-carbon1-concentration;'
   cdunits='#/cm3;'

elseif(cvar(1:lv).eq.'brown_carbon2_concen') then
   ivar_type=3
   ierr=rams_getvar('BRC2NP',idim_type,ngrd,a,flnm)
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   if(ierr.eq.0) then
    CALL rams_comp_dn0 (n1,n2,n3,b,c,d,e,ngrd)
    CALL rams_comp_mult (n1,n2,n3,a,d)
   ...
   cdname='brown-carbon2-concentration;'
   cdunits='#/cm3;'
...
elseif(cvar(1:lv).eq.'ifn_inrain') then
   ...
   cdunits='#/cm3;'
!Bee added for aerosol budget 2021-07-12
elseif(cvar(1:lv).eq.'vertint_aero') then
   ivar_type=2
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   CALL rams_comp_dn0 (n1,n2,n3,c,b,d,e,ngrd)
   CALL rams_comp_zero (n1,n2,n3,a)
   ierr=rams_getvar('CCCMP',idim_type,ngrd,c,flnm)
   if(ierr.eq.0) CALL rams_comp_accum (n1,n2,n3,a,c)
   CALL rams_comp_mult (n1,n2,n3,a,d)
   CALL rams_comp_vertint (n1,n2,n3,a,e,ngrd)
   CALL rams_comp_mults (n1,n2,n3,a,1.e3)
   cdname='vertint-unprocessed-aero;'
   cdunits='grams/m2;'

elseif(cvar(1:lv).eq.'vertint_aero_hydro') then
   ivar_type=2
   iany=1
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   CALL rams_comp_dn0 (n1,n2,n3,c,b,d,e,ngrd)
   ...
   CALL rams_comp_vertint (n1,n2,n3,a,e,ngrd)
   CALL rams_comp_mults (n1,n2,n3,a,1.e3)
   cdname='vertint-aero-in-hydromets;'
   cdunits='grams/m2;'

elseif(cvar(1:lv).eq.'vertint_aero_reg') then
   ivar_type=2
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   CALL rams_comp_dn0 (n1,n2,n3,c,b,d,e,ngrd)
   CALL rams_comp_zero (n1,n2,n3,a)
   ...
   CALL rams_comp_vertint (n1,n2,n3,a,e,ngrd)
   CALL rams_comp_mults (n1,n2,n3,a,1.e3)
   cdname='vertint-regenerated-aero;'
   cdunits='grams/m2;'

elseif(cvar(1:lv).eq.'vertint_aero_reg1') then
   ivar_type=2
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   CALL rams_comp_dn0 (n1,n2,n3,c,b,d,e,ngrd)
   CALL rams_comp_zero (n1,n2,n3,a)
   ...
   CALL rams_comp_vertint (n1,n2,n3,a,e,ngrd)
   CALL rams_comp_mults (n1,n2,n3,a,1.e3)
   cdname='vertint-regenerated-aero1;'
   cdunits='grams/m2;'

elseif(cvar(1:lv).eq.'vertint_aero_reg2') then
   ivar_type=2
   ierr=rams_getvar('TOPT',idim_type,ngrd,e,flnm)
   CALL rams_comp_dn0 (n1,n2,n3,c,b,d,e,ngrd)
   CALL rams_comp_zero (n1,n2,n3,a)
   ...
   CALL rams_comp_vertint (n1,n2,n3,a,e,ngrd)
   CALL rams_comp_mults (n1,n2,n3,a,1.e3)
   cdname='vertint-regenerated-aero2;'
   cdunits='grams/m2;'

elseif(cvar(1:lv).eq.'accpaero_g') then
   ivar_type=2
   ierr=rams_getvar('ACCPAERO',idim_type,ngrd,a,flnm)
   CALL rams_comp_mults (n1,n2,n3,a,1.e3)
   cdname='accum-surface-aero;'
   cdunits='grams/m2;'
!###############################################################################
!3D VERTICAL VELOCITY AND MICROPHYSICAL BUDGETS (INSTANTANEOUS) - 15 variables
!###############################################################################
...
!###############################################################################
!3D VERTICAL VELOCITY AND MICROPHYSICAL TOTAL BUDGETS - 88 variables
