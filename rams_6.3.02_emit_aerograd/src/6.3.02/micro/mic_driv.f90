...
if (ibrnc > 0) then
   CALL ae1kmic (2,m1-1,micro%brc1np(1,i,j),aerocon(1,8))
   CALL ae1kmic (2,m1-1,micro%brc1mp(1,i,j),aeromas(1,8))
   CALL ae1kmic (2,m1-1,micro%brc2np(1,i,j),aerocon(1,9))
   CALL ae1kmic (2,m1-1,micro%brc2mp(1,i,j),aeromas(1,9))
endif
