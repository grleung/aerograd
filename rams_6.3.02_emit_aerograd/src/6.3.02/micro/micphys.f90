...
integer :: level,icloud,idriz,irain,ipris,isnow,iaggr,igraup,ihail      &
  ,irime,iplaws,iaerosol,idust,idustloft,ibrnc,isalt,iaerorad,iifn      &
...
real :: cin_max,ccn_max,gccn_max,dust1_max,dust2_max,saltf_max,saltj_max &
 ...
 ,power,scnmass,dcnmass,dinmass,brnc1_max,brnc2_max
...
data aero_sigma  / 1.80 &       !CCN 
                  ...
                  ,1.80 &       !brown carbon mode-1
                  ,1.80 &       !brown carbon mode-2
...
data aero_rg2rm  / 1.6791 &     !CCN 
                  ...
                  ,1.6791 &     !brown carbon mode-1
                  ,1.6791 &     !brown carbon mode-2
