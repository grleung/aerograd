...
if(ibrnc > 0) then
 CALL iofil ('brc1np.txt',micro_g(ng)%brc1np(:,i,j),m1,wf,fln)
 CALL iofil ('brc2np.txt',micro_g(ng)%brc2np(:,i,j),m1,wf,fln)
 CALL iofil ('brc1mp.txt',micro_g(ng)%brc1mp(:,i,j),m1,wf,fln)
 CALL iofil ('brc2mp.txt',micro_g(ng)%brc2mp(:,i,j),m1,wf,fln)
endif
